...
public static void main(String args[]) 
	...
	String ans = stdin.next(); n = getNextPrime(ans);
	System.out.println("First prime is: " + n + ".");System.out.println();
	
	// Get the base for exponentiation from the user. 
	System.out.print("Enter the second prime no(between 2 and " + n +" ):"); 
	BigInteger g = new BigInteger(stdin.next());
	System.out.println("Second prime is: " + g + ".");System.out.println();
	...
	System.out.println("Person A sends " + resulta + " to person B.");System.out.println();
	...
	System.out.println("Person B sends " + resultb + " to person A.");System.out.println();
	...
	System.out.println("The Key A calculates is " + KeyACalculates + ".");System.out.println();
